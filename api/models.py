...
class messages_privees(models.Model):
    '''
        Actuellement ce modèle n'est pas utilisé, la raison est que messages_forum
        peut jouer le même rôle que les messages privés, mais je le garde pour le moment
    '''
    message_id = models.UUIDField(primary_key = True, default = uuid.uuid4, editable = False)
